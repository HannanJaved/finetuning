#!/bin/bash
#SBATCH --job-name=8258_steps_beta0.01_lr5e7_bs128
#SBATCH --output=/data/cat/ws/hama901h-RL/.logs/optimal-N/dpo_on_16516sft_tulu3/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-RL/.logs/optimal-N/dpo_on_16516sft_tulu3/%x_%j.err
#SBATCH --nodes=2
...
CONFIG_FILE=/data/cat/ws/hama901h-RL/hpopt/Llama-8B-optimal-N/optimal-DPO-for-16516/dpo_8258.yaml
