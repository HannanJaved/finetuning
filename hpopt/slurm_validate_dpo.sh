...
# =============================================================================
# DPO Validation SLURM Job
# =============================================================================
# Usage: sbatch slurm_validate_dpo.sh <CONFIG_FILE>
# =============================================================================
...
if [ -z "$CONFIG_FILE" ]; then
    ...
    echo "Usage: sbatch slurm_validate_dpo.sh <CONFIG_FILE>"
    exit 1
fi

echo "=============================================="
echo "DPO Validation Job"
...
CMD="scripts/validate_dpo.py --config $CONFIG_FILE"
