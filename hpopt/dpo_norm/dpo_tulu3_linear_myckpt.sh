...
#SBATCH --output=/data/cat/ws/hama901h-RL/.logs/Tulu3_DPO_NORM/my-ckpts/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-RL/.logs/Tulu3_DPO_NORM/my-ckpts/%x_%j.err
#SBATCH --nodes=2
...
CONFIG_FILE=/data/cat/ws/hama901h-RL/hpopt/dpo_norm/config_tulu3_dpo_linear_myckpt.yaml
