#!/bin/bash
#SBATCH --job-name=sft_test_config
#SBATCH --output=/data/cat/ws/hama901h-RL/.logs/early_stopping/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-RL/.logs/early_stopping/%x_%j.err
#SBATCH --nodes=2
...
CONFIG_FILE=/data/cat/ws/hama901h-RL/hpopt/early-stopping/test-config-sft.yaml
...
#LAUNCHERS
export CMD="scripts/sft_early_stopping.py --config $CONFIG_FILE"
