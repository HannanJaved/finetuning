#!/bin/bash
#SBATCH --job-name=dpo_test_config
...
CONFIG_FILE=/data/cat/ws/hama901h-RL/hpopt/early-stopping/test-config.yaml
...
#LAUNCHERS
export CMD="scripts/dpo_early_stopping.py --config $CONFIG_FILE"
