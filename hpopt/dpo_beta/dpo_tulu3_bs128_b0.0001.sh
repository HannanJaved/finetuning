#!/bin/bash
#SBATCH --job-name=dpo_tulu3_bs128_b0.0001
#SBATCH --output=/data/cat/ws/hama901h-RL/.logs/Tulu3_SFT/beta/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-RL/.logs/Tulu3_SFT/beta/%x_%j.err
#SBATCH --nodes=2
...
CONFIG_FILE=/data/cat/ws/hama901h-RL/hpopt/dpo_beta/config_tulu3_bs128_b0.0001.yaml
