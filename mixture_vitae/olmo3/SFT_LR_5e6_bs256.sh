#!/bin/bash
#SBATCH --job-name=SFT_BS256_LR5e6_Olmo3
#SBATCH --output=/data/cat/ws/hama901h-Posttraining/.logs/MixtureVitae/Olmo3/SFT_Grid_Search/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Posttraining/.logs/MixtureVitae/Olmo3/SFT_Grid_Search/%x_%j.err
#SBATCH --nodes=2
...
CONFIG_FILE=/data/cat/ws/hama901h-Posttraining/finetuning/mixture_vitae/olmo3/config_sft_lr5e6_bs_256.yaml
