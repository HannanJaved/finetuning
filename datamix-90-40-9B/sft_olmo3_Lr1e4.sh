#!/bin/bash
#SBATCH --job-name=olmo3-Lr1e4-datamix90-40-9B
...
CONFIG_FILE=/home/hk-project-p0024043/hgf_ivw0083/ws/hkfswork/hgf_ivw0083-Post-training/finetuning/datamix-90-40-9B/config_olmo3_sft_Lr1e4.yaml
