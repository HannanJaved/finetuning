#!/bin/bash
#SBATCH --job-name=Gemma3-1B-DPO-Beta0.01_LR1e-6
...
export WANDB_NAME=Gemma3-1B-DPO-Beta0.01_LR1e-6
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/gemma3/1B/DPO/dpo_beta0.01_LR1e-6.yaml
