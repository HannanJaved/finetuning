#!/bin/bash
#SBATCH --job-name=Val-Gemma3-1B-DPO-Beta0.01_LR3e-6
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/gemma3/1B/DPO/validate_dpo_beta0.01_LR3e-6_1B.yaml
