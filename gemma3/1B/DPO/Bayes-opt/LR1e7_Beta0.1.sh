#!/bin/bash
#SBATCH --job-name=1B_olmo_LR1e7_Beta0.1
#SBATCH --output=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Gemma3/1B/DPO/SFT-LR3e-5/BayesOpt/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Gemma3/1B/DPO/SFT-LR3e-5/BayesOpt/%x_%j.err
#SBATCH --nodes=4
...
export WANDB_NAME=Gemma3-1B-SFT-LR1e-6-DPO-Beta0.1-LR1e-7
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/gemma3/1B/DPO/Bayes-opt/dpo_beta0.1_LR.yaml
