#!/bin/bash
#SBATCH --job-name=Val-Gemma3-1B-DPO-Beta0.05_LR1e-5
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Gemma3/1B/DPO/validate/%x_%j.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Gemma3/1B/DPO/validate/%x_%j.err
#SBATCH --nodes=1
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/gemma3/1B/DPO/validate_dpo_beta0.05_LR1e-5_1B.yaml
