#!/bin/bash
#SBATCH --job-name=Val-Gemma3-1B-DPO-Beta0.3_LR1e-5
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/gemma3/1B/DPO/validate_dpo_beta0.3_LR1e-5_1B.yaml
