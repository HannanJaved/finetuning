#!/bin/bash
#SBATCH --job-name=Gemma3-1B-SFT-LR3e-5
...
bash /data/cat/ws/hama901h-Post-training/cache.sh
...
export WANDB_NAME=Gemma3-1B-SFT-LR3e-5
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/gemma3/1B/config_olmo3_sft_3e-5.yaml
