...
for lr in "${LRS[@]}"; do
  for beta in "${BETAS[@]}"; do
    ...
    job_name="Gemma3-4B-DPO-Beta${beta}_LR${lr}"
    ...
    sed \
      ...
      -e "s/^beta: .*/beta: ${beta}/" \
      -e "s#^output_dir: .*#output_dir: /data/horse/ws/hama901h-BFTranslation/checkpoints/Gemma3/gemma-3-4b-pt/SFT-sweep/gemma-3-4b-pt-SFT-LR3e-5/DPO/Beta${beta}_LR${lr}/#" \
