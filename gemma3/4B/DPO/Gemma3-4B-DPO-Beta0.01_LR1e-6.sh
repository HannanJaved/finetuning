#!/bin/bash
#SBATCH --job-name=Gemma3-4B-DPO-Beta0.01_LR1e-6
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Gemma3/4B/DPO/SFT-LR1e-7/%x_%j.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Gemma3/4B/DPO/SFT-LR1e-7/%x_%j.err
#SBATCH --nodes=2
...
export WANDB_NAME=Gemma3-4B-DPO-Beta0.01_LR1e-6
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/gemma3/4B/DPO/dpo_beta0.01_LR1e-6.yaml
