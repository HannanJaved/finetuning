#!/bin/bash
#SBATCH --job-name=Gemma3-4B-DPO-Beta0.1_LR1e-7
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO_AO/dpo_beta0.08_LR1e-6.yaml
