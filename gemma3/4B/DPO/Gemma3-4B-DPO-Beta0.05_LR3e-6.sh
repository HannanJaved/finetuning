#!/bin/bash
#SBATCH --job-name=Gemma3-4B-DPO-Beta0.05_LR3e-6
...
export WANDB_NAME=Gemma3-4B-DPO-Beta0.05_LR3e-6
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/gemma3/4B/DPO/dpo_beta0.05_LR3e-6.yaml
