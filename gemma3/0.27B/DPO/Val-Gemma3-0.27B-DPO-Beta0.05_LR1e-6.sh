#!/bin/bash
#SBATCH --job-name=Val-Gemma3-0.27B-DPO-Beta0.05_LR1e-6
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/gemma3/0.27B/DPO/validate_dpo_beta0.05_LR1e-6_0.27B.yaml
