...
for lr in "${LRS[@]}"; do
  for beta in "${BETAS[@]}"; do
    ...
    job_name="Gemma3-0.27B-DPO-Beta${beta}_LR${lr}"
    ...
    sed \
      ...
      -e "s/^beta: .*/beta: ${beta}/" \
      -e "s#^output_dir: .*#output_dir: /data/horse/ws/hama901h-BFTranslation/checkpoints/Gemma3/gemma-3-270m/SFT-sweep/gemma-3-270m-SFT-LR3e-5/DPO/Beta${beta}_LR${lr}/#" \
