#!/bin/bash
#SBATCH --job-name=Gemma3-0.27B-DPO-Beta0.1_LR5e-6
...
export WANDB_NAME=Gemma3-0.27B-DPO-Beta0.1_LR5e-6
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/gemma3/0.27B/DPO/dpo_beta0.1_LR5e-6.yaml
