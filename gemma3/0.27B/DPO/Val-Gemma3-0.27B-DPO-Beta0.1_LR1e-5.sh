#!/bin/bash
#SBATCH --job-name=Val-Gemma3-0.27B-DPO-Beta0.1_LR1e-5
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/gemma3/0.27B/DPO/validate_dpo_beta0.1_LR1e-5_0.27B.yaml
