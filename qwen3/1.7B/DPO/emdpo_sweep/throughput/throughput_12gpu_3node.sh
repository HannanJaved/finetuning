#!/bin/bash
#SBATCH --job-name=emdpo_tp_12g3n
#SBATCH --output=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/DPO_N/throughput/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/DPO_N/throughput/%x_%j.err
#SBATCH --nodes=3
...
CONFIG_FILE=/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/DPO/emdpo_sweep/throughput/config_emdpo_throughput_12gpu_3node.yaml

echo "JOBNAME" $SLURM_JOB_NAME
echo "CONFIG" $CONFIG_FILE
pwd -P

export CMD="scripts/emdpo.py --config $CONFIG_FILE"
