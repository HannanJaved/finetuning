#!/bin/bash
#SBATCH --job-name=Qwen3-1.7B-DPO-SFT_1e-5-Beta1.0_LR5e-5
...
export WANDB_NAME=Qwen3-1.7B-DPO-SFT_1e-5-Beta1.0_LR5e-5
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/1.7B/DPO/SFT-Lr1e-5/dpo_beta1.0_LR5e-5.yaml
