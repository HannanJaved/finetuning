#!/bin/bash
#SBATCH --job-name=Qwen3-1.7B-DPO-SFT_1e-5-Beta0.3_LR5e-6
...
export WANDB_NAME=Qwen3-1.7B-DPO-SFT_1e-5-Beta0.3_LR5e-6
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/1.7B/DPO/SFT-Lr1e-5/dpo_beta0.3_LR5e-6.yaml
