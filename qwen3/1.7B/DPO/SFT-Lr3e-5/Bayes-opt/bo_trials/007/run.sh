#!/bin/bash
#SBATCH --job-name=Qwen3-1.7B-DPO-BO-t007
...
export WANDB_NAME=Qwen3-1.7B-DPO-BO-t007
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/1.7B/DPO/SFT-Lr3e-5/Bayes-opt/bo_trials/007/config.yaml
