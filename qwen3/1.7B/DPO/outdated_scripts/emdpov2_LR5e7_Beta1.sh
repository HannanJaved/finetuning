#!/bin/bash
#SBATCH --job-name=emdpov2_LR5e7_Beta1
...
CONFIG_FILE=${CONFIG_FILE:-/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/DPO/config_emdpov2_LR5e7_Beta1.yaml}

echo "JOBNAME" $SLURM_JOB_NAME
echo "CONFIG" $CONFIG_FILE
pwd -P

export CMD="scripts/emdpo_v2.py --config $CONFIG_FILE"
