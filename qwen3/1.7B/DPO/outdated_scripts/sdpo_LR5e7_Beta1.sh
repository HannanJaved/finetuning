#!/bin/bash
#SBATCH --job-name=sdpo_LR5e7_Beta1
...
CONFIG_FILE=${CONFIG_FILE:-/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/DPO/config_sdpo_LR5e7_Beta1_k1.0_tau0.99_ref2.0_pol1.0_ag0.75_len0.25_eps0.20.yaml}

echo "JOBNAME" $SLURM_JOB_NAME
echo "CONFIG" $CONFIG_FILE
pwd -P

export CMD="scripts/sdpo.py --config $CONFIG_FILE"
