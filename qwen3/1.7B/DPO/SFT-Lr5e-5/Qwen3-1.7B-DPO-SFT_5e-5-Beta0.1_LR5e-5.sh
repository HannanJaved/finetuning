#!/bin/bash
#SBATCH --job-name=Qwen3-1.7B-DPO-SFT_5e-5-Beta0.1_LR5e-5
...
export WANDB_NAME=Qwen3-1.7B-DPO-SFT_5e-5-Beta0.1_LR5e-5
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/1.7B/DPO/SFT-Lr5e-5/dpo_beta0.1_LR5e-5.yaml
