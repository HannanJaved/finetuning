#!/bin/bash
#SBATCH --job-name=Qwen3-1.7B-DPO-VAL
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/1.7B/DPO-AO/SFT-LR3e-5/%x_%A_%a.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/1.7B/DPO-AO/SFT-LR3e-5/%x_%A_%a.err
#SBATCH --nodes=1
...
export WANDB_NAME="Qwen3-1.7B-DPO-VAL-LR${LR}-Beta${BETA}"

DPO_AO_DIR="/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/1.7B/DPO_AO"
