#!/bin/bash
#SBATCH --job-name=DPO-LR1e7-Beta0.1-Qwen3-1.7B-SFT-LR3e-5-AO
...
export WANDB_NAME=DPO-LR1e7-Beta0.1-Qwen3-1.7B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/1.7B/DPO_AO/dpo_beta0.1_LR.yaml
