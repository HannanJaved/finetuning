#!/bin/bash
#SBATCH --job-name=DPO-LR2e-6_Beta0.02-Qwen3-1.7B-SFT-LR3e-5-AO
...
export WANDB_NAME=DPO-LR2e-6_Beta0.02-Qwen3-1.7B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/1.7B/DPO_AO/dpo_beta0.02_LR2e-6.yaml
