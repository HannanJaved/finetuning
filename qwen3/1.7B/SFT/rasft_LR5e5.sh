#!/bin/bash
#SBATCH --job-name=rasft_LR5e5
#SBATCH --output=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/RA-SFT/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/RA-SFT/%x_%j.err
#SBATCH --nodes=2
...
export TRITON_CACHE_DIR="/data/cat/ws/hama901h-Posttraining/.cache/triton"
...
CONFIG_FILE=${CONFIG_FILE:-/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/SFT/config_rasft_LR5e5.yaml}

echo "JOBNAME" $SLURM_JOB_NAME
echo "CONFIG" $CONFIG_FILE
pwd -P

export CMD="scripts/rasft.py --config $CONFIG_FILE"
