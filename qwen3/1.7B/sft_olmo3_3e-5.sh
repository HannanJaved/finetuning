#!/bin/bash
#SBATCH --job-name=Qwen3-1.7B-SFT-LR3e-5
#SBATCH --output=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/%x_%j.err
#SBATCH --nodes=2
...
export WANDB_NAME=Qwen3-1.7B-SFT-LR3e-5
...
CONFIG_FILE=/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/1.7B/config_olmo3_sft_3e-5.yaml
