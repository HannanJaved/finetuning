#!/bin/bash
#SBATCH --job-name=Qwen3-0.6B-SFT-LR1e-6
...
export WANDB_NAME=Qwen3-0.6B-SFT-LR1e-6
...
CONFIG_FILE=/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/0.6B/config_olmo3_sft_1e-6.yaml
