#!/bin/bash
#SBATCH --job-name=DPO-LR8e-6_Beta0.02-Qwen3-0.6B-SFT-LR3e-5-AO-UltraFeedback
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/0.6B/DPO-AO-UltraFeedback-DDP/SFT-LR3e-5/%x_%j.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/0.6B/DPO-AO-UltraFeedback-DDP/SFT-LR3e-5/%x_%j.err
#SBATCH --nodes=1
...
export WANDB_NAME=DPO-LR8e-6_Beta0.02-Qwen3-0.6B-SFT-LR3e-5-AO-UltraFeedback
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/0.6B/DPO_AO_UltraFeedback/dpo_beta0.02_LR8e-6.yaml
