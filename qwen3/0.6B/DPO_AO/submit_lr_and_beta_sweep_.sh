...
# LRS=(1e-6 2e-6 4e-6)
# Grid diagnostic (lr_vs_zall_by_scale plots) showed 0.6B's Z-All score
...
for lr in "${LRS[@]}"; do
  for beta in "${BETAS[@]}"; do
    ...
    job_name="DPO-LR${lr}_Beta${beta}-Qwen3-0.6B-SFT-LR3e-5-AO"
    ...
    sed \
      ...
      -e "s/^beta: .*/beta: ${beta}/" \
      -e "s#^output_dir: .*#output_dir: /data/horse/ws/hama901h-BFTranslation/checkpoints/Qwen/Qwen3-0.6B-Base/SFT-sweep/Qwen3-0.6B-SFT-LR3e-5-Assistant-Only/olmo3-dpo/${job_name}/#" \
