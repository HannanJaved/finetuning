#!/bin/bash
#SBATCH --job-name=DPO-LR1e-6_Beta0.01-Qwen3-0.6B-SFT-LR3e-5-AO
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/0.6B/DPO-AO/SFT-LR3e-5/%x_%j.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/0.6B/DPO-AO/SFT-LR3e-5/%x_%j.err
#SBATCH --nodes=2
...
export WANDB_NAME=DPO-LR1e-6_Beta0.01-Qwen3-0.6B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/0.6B/DPO_AO/dpo_beta0.01_LR1e-6.yaml
