#!/bin/bash
#SBATCH --job-name=Qwen3-0.6B-SFT-LR5e-4
#SBATCH --output=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/0.6B/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/0.6B/%x_%j.err
#SBATCH --nodes=2
...
export WANDB_NAME=Qwen3-0.6B-SFT-LR5e-4
...
CONFIG_FILE=/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/0.6B/config_olmo3_sft_5e-4.yaml
