#!/bin/bash
#SBATCH --job-name=Qwen3-0.6B-DPO-SFT_5e-4-Beta0.3_LR3e-6
...
export WANDB_NAME=Qwen3-0.6B-DPO-SFT_5e-4-Beta0.3_LR3e-6
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/0.6B/DPO/SFT-Lr5e-4/dpo_beta0.3_LR3e-6.yaml
