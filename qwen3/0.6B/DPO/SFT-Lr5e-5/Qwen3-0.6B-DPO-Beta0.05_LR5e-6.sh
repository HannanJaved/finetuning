#!/bin/bash
#SBATCH --job-name=Qwen3-0.6B-DPO-Beta0.05_LR5e-6
#SBATCH --output=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/0.6B/DPO/SFT-LR5e-5/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/0.6B/DPO/SFT-LR5e-5/%x_%j.err
#SBATCH --nodes=2
...
export WANDB_NAME=Qwen3-0.6B-DPO-Beta0.05_LR5e-6
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/0.6B/DPO/SFT-Lr5e-5/dpo_beta0.05_LR5e-6.yaml
