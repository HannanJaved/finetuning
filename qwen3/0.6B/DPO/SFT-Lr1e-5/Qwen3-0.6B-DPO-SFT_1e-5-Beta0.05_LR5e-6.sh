#!/bin/bash
#SBATCH --job-name=Qwen3-0.6B-DPO-SFT_1e-5-Beta0.05_LR5e-6
...
export WANDB_NAME=Qwen3-0.6B-DPO-SFT_1e-5-Beta0.05_LR5e-6
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/0.6B/DPO/SFT-Lr1e-5/dpo_beta0.05_LR5e-6.yaml
