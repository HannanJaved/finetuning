#!/bin/bash
#SBATCH --job-name=Qwen3-0.6B-DPO-Beta0.1_LR1e-7
...
export WANDB_NAME=Qwen3-0.6B-DPO-Beta0.1_LR1e-7
...
CONFIG_FILE=/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/0.6B/DPO/SFT-Lr3e-5/dpo_beta0.1_LR1e-7.yaml
