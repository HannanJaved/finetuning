#!/bin/bash
#SBATCH --job-name=Qwen3-0.6B-DPO-BO-t001
...
export WANDB_NAME=Qwen3-0.6B-DPO-BO-t001
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/0.6B/DPO/SFT-Lr3e-5/Bayes-opt/bo_trials/001/config.yaml
