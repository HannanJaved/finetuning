#!/bin/bash
#SBATCH --job-name=Qwen3-0.6B-SFT-LR3e-5_AO
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/0.6B/%x_%j.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/0.6B/%x_%j.err
#SBATCH --nodes=2
...
export WANDB_NAME=Qwen3-0.6B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/0.6B/config_olmo3_sft_3e-5_AO.yaml
