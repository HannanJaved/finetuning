#!/bin/bash
#SBATCH --job-name=DPO-LR1e-6_Beta0.04-Qwen3-8B-SFT-LR3e-5-AO-UltraFeedback
...
export WANDB_NAME=DPO-LR1e-6_Beta0.04-Qwen3-8B-SFT-LR3e-5-AO-UltraFeedback
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/8B/DPO_AO_UltraFeedback/dpo_beta0.04_LR1e-6.yaml
