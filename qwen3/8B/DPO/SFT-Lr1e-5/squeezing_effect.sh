...
#SBATCH --output=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/8B/DPO/SFT-LR1e-5/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/8B/DPO/SFT-LR1e-5/%x_%j.err
#SBATCH --nodes=4
...
export WANDB_NAME=Qwen3-8B-SFT-LR1e-5-DPO-Squeezing_effect
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/8B/DPO/SFT-Lr1e-5/squeezing_effect.yaml
