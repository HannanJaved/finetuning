#!/bin/bash
#SBATCH --job-name=8B_olmo_LR1e7_Beta0.1
...
export WANDB_NAME=Qwen3-8B-SFT-LR1e-5-DPO-Beta0.1-LR1e-7
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/8B/DPO/SFT-Lr1e-5/dpo_beta0.1_LR.yaml
