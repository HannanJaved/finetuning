#!/bin/bash
#SBATCH --job-name=Qwen3-8B-DPO-SFT_1e-5-Beta0.5_LR5e-6
...
export WANDB_NAME=Qwen3-8B-DPO-SFT_1e-5-Beta0.5_LR5e-6
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/8B/DPO/SFT-Lr1e-5/dpo_beta0.5_LR5e-6.yaml
