#!/bin/bash
#SBATCH --job-name=Qwen3-8B-DPO-SFT_1e-5-Beta0.05_LR1e-6
...
export WANDB_NAME=Qwen3-8B-DPO-SFT_1e-5-Beta0.05_LR1e-6
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/8B/DPO/SFT-Lr5e-4/dpo_beta0.05_LR1e-6.yaml
