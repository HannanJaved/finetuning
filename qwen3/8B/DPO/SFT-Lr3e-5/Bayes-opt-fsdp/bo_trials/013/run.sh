#!/bin/bash
#SBATCH --job-name=Qwen3-8B-DPO-BO-t013
...
export WANDB_NAME=Qwen3-8B-DPO-BO-t013
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/8B/DPO/SFT-Lr3e-5/Bayes-opt-fsdp/bo_trials/013/config.yaml
