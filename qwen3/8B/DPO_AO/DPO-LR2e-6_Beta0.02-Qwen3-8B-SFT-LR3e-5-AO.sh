#!/bin/bash
#SBATCH --job-name=DPO-LR2e-6_Beta0.02-Qwen3-8B-SFT-LR3e-5-AO
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/8B/DPO-AO/SFT-LR3e-5/%x_%j.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/8B/DPO-AO/SFT-LR3e-5/%x_%j.err
#SBATCH --nodes=2
...
export WANDB_NAME=DPO-LR2e-6_Beta0.02-Qwen3-8B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/8B/DPO_AO/dpo_beta0.02_LR2e-6.yaml
