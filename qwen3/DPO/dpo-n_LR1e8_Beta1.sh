#!/bin/bash
#SBATCH --job-name=dpo_norm_LR1e8_Beta1
...
CONFIG_FILE=/home/hk-project-p0024043/hgf_ivw0083/ws/hkfswork/hgf_ivw0083-Post-training/finetuning/qwen3/DPO/config_dpo-n_LR1e8_Beta1.yaml
