#!/bin/bash
#SBATCH --job-name=sdpo_lite_LR5e7_Beta1
...
CONFIG_FILE=${CONFIG_FILE:-/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/DPO/config_sdpo_lite_LR5e7_Beta1_ret0.2_tau0.99.yaml}

echo "JOBNAME" $SLURM_JOB_NAME
echo "CONFIG" $CONFIG_FILE
pwd -P

export CMD="scripts/sdpo-lite.py --config $CONFIG_FILE"
