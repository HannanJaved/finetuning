...
#SBATCH --output=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/DPO_N/RandomSearch/dpo_random_9_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/DPO_N/RandomSearch/dpo_random_9_%j.err
#SBATCH --nodes=2
