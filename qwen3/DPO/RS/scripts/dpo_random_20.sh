...
CONFIG_FILE=/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/DPO/RS/configs/config_dpo_random_20.yaml

srun --wait=60 --kill-on-bad-exit=1 bash -c "accelerate launch --config_file  --num_machines  --num_processes  --main_process_ip  --main_process_port  scripts/dpo.py --config /data/cat/ws/hama901h-Posttraining/finetuning/qwen3/DPO/RS/configs/config_dpo_random_20.yaml"
