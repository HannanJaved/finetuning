#!/bin/bash
#SBATCH --job-name=dpo_norm_LR5e7_Beta10
...
CONFIG_FILE=/home/hk-project-p0024043/hgf_ivw0083/ws/hkfswork/hgf_ivw0083-Post-training/finetuning/qwen3/DPO/config_dpo-n_LR5e7_Beta10.yaml
