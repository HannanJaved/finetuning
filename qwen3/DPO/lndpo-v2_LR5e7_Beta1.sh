#!/bin/bash
#SBATCH --job-name=lndpo_v2_LR5e7_Beta1
...
CONFIG_FILE=${CONFIG_FILE:-/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/DPO/config_lndpo-v2_LR5e7_Beta1_eps0.30.yaml}

echo "JOBNAME" $SLURM_JOB_NAME
echo "CONFIG" $CONFIG_FILE
pwd -P

export CMD="scripts/lndpo-v2.py --config $CONFIG_FILE"
