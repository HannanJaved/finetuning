#!/bin/bash
#SBATCH --job-name=emdpo_tp_16g4n
...
CONFIG_FILE=/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/DPO/emdpo_sweep/throughput/config_emdpo_throughput_16gpu_4node.yaml
