#!/bin/bash
#SBATCH --job-name=emdpo_lite_LR5e7_Beta1
#SBATCH --output=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/EMDPO_Lite/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/EMDPO_Lite/%x_%j.err
#SBATCH --nodes=2
...
CONFIG_FILE=${CONFIG_FILE:-/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/DPO/emdpo_sweep/config_emdpo_lite_LR5e7_Beta1_ref1.0.yaml}

echo "JOBNAME" $SLURM_JOB_NAME
echo "CONFIG" $CONFIG_FILE
pwd -P

export CMD="scripts/emdpo-lite.py --config $CONFIG_FILE"
