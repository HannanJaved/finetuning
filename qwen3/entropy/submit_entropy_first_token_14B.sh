...
JOB_SCRIPT="/data/horse/ws/hama901h-BFTranslation/finetuning/qwen3/entropy/run_entropy_first_token_job.sh"
...
for lr in "${LRS[@]}"; do
  ...
  job_name="entropy-first-token-${SIZE}-LR${lr}"
  result_dir="/data/horse/ws/hama901h-BFTranslation/finetuning/qwen3/entropy/results_first_token/${SIZE}"
