#!/bin/bash
#SBATCH --job-name=Qwen3-4B-SFT-VAL
#SBATCH --output=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/4B/%x_%A_%a.out
#SBATCH --error=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/4B/%x_%A_%a.err
#SBATCH --nodes=1
...
BASE_DIR="/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B"
LRS=(5e-4 1e-5 3e-5 5e-5 1e-6)
LR=${LRS[$SLURM_ARRAY_TASK_ID]}
export WANDB_NAME="Qwen3-4B-SFT-VAL-LR${LR}"
