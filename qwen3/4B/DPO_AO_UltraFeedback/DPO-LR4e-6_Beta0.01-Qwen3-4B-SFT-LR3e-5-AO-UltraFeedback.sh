#!/bin/bash
#SBATCH --job-name=DPO-LR4e-6_Beta0.01-Qwen3-4B-SFT-LR3e-5-AO-UltraFeedback
...
export WANDB_NAME=DPO-LR4e-6_Beta0.01-Qwen3-4B-SFT-LR3e-5-AO-UltraFeedback
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO_AO_UltraFeedback/dpo_beta0.01_LR4e-6.yaml
