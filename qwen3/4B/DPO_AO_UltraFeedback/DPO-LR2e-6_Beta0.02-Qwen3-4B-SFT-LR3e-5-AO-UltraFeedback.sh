#!/bin/bash
#SBATCH --job-name=DPO-LR2e-6_Beta0.02-Qwen3-4B-SFT-LR3e-5-AO-UltraFeedback
...
export WANDB_NAME=DPO-LR2e-6_Beta0.02-Qwen3-4B-SFT-LR3e-5-AO-UltraFeedback
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO_AO_UltraFeedback/dpo_beta0.02_LR2e-6.yaml
