#!/bin/bash
#SBATCH --job-name=DPO-BOtrial005_Beta0.4412_LR4.86e-05-Qwen3-4B-SFT-LR3e-5-AO
...
export WANDB_NAME=DPO-BOtrial005_Beta0.4412_LR4.86e-05-Qwen3-4B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO_AO/dpo_bo-trial005_beta0.4412_LR4.86e-05.yaml
