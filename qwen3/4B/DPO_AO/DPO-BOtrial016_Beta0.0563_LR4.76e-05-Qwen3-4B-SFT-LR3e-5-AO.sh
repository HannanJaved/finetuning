#!/bin/bash
#SBATCH --job-name=DPO-BOtrial016_Beta0.0563_LR4.76e-05-Qwen3-4B-SFT-LR3e-5-AO
...
export WANDB_NAME=DPO-BOtrial016_Beta0.0563_LR4.76e-05-Qwen3-4B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO_AO/dpo_bo-trial016_beta0.0563_LR4.76e-05.yaml
