#!/bin/bash
#SBATCH --job-name=DPO-BOtrial007_Beta0.0126_LR1.22e-05-Qwen3-4B-SFT-LR3e-5-AO
...
export WANDB_NAME=DPO-BOtrial007_Beta0.0126_LR1.22e-05-Qwen3-4B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO_AO/dpo_bo-trial007_beta0.0126_LR1.22e-05.yaml
