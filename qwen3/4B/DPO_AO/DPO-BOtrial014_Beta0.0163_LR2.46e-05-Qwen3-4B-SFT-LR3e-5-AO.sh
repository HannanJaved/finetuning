#!/bin/bash
#SBATCH --job-name=DPO-BOtrial014_Beta0.0163_LR2.46e-05-Qwen3-4B-SFT-LR3e-5-AO
...
export WANDB_NAME=DPO-BOtrial014_Beta0.0163_LR2.46e-05-Qwen3-4B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO_AO/dpo_bo-trial014_beta0.0163_LR2.46e-05.yaml
