#!/bin/bash
#SBATCH --job-name=DPO-LR4e-7_Beta0.01-Qwen3-4B-SFT-LR3e-5-AO
...
export WANDB_NAME=DPO-LR4e-7_Beta0.01-Qwen3-4B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO_AO/dpo_beta0.01_LR4e-7.yaml
