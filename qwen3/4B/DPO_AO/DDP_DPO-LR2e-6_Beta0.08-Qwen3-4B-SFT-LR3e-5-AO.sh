#!/bin/bash
#SBATCH --job-name=DDP_DPO-LR2e-6_Beta0.08-Qwen3-4B-SFT-LR3e-5-AO
...
export WANDB_NAME=DDP_DPO-LR2e-6_Beta0.08-Qwen3-4B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO_AO/dpo_beta0.08_LR2e-6.yaml
