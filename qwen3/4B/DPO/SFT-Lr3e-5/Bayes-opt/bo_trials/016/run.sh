#!/bin/bash
#SBATCH --job-name=Qwen3-4B-DPO-BO-t016
...
export WANDB_NAME=Qwen3-4B-DPO-BO-t016
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO/SFT-Lr3e-5/Bayes-opt/bo_trials/016/config.yaml
