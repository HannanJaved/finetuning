#!/bin/bash
#SBATCH --job-name=Qwen3-4B-DPO-BO-t004
...
export WANDB_NAME=Qwen3-4B-DPO-BO-t004
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO/SFT-Lr3e-5/Bayes-opt/bo_trials/004/config.yaml
