#!/bin/bash
#SBATCH --job-name=4B_olmo_LR1e7_Beta0.1
#SBATCH --output=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/4B/DPO/SFT-LR3e-5/BayesOpt/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/4B/DPO/SFT-LR3e-5/BayesOpt/%x_%j.err
#SBATCH --nodes=4
...
export WANDB_NAME=Qwen3-4B-SFT-LR1e-6-DPO-Beta0.1-LR1e-7
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO/SFT-Lr3e-5/dpo_beta0.1_LR.yaml
