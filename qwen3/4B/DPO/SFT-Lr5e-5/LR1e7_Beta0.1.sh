...
export WANDB_NAME=Qwen3-4B-SFT-LR5e-5-DPO-Beta0.1-LR1e-7
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/4B/DPO/SFT-Lr5e-5/dpo_beta0.1_LR.yaml
