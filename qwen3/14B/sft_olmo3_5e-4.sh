#!/bin/bash
#SBATCH --job-name=Qwen3-14B-SFT-LR5e-4
...
export WANDB_NAME=Qwen3-14B-SFT-LR5e-4
...
CONFIG_FILE=/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/14B/config_olmo3_sft_5e-4.yaml
