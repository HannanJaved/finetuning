#!/bin/bash
#SBATCH --job-name=Qwen3-14B-SFT-LR1e-5
#SBATCH --output=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/14B/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3/14B/%x_%j.err
#SBATCH --nodes=2
...
export WANDB_NAME=Qwen3-14B-SFT-LR1e-5
...
CONFIG_FILE=/data/cat/ws/hama901h-Posttraining/finetuning/qwen3/14B/config_olmo3_sft_1e-5.yaml
