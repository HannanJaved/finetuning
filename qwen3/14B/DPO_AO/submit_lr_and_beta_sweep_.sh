...
for lr in "${LRS[@]}"; do
  for beta in "${BETAS[@]}"; do
    ...
    job_name="DPO-LR${lr}_Beta${beta}-Qwen3-14B-SFT-LR3e-5-AO"
    ...
    sed \
      ...
      -e "s/^beta: .*/beta: ${beta}/" \
      -e "s#^output_dir: .*#output_dir: /data/horse/ws/hama901h-BFTranslation/checkpoints/Qwen/Qwen3-114B-Base/SFT-sweep/Qwen3-114B-SFT-LR3e-5/Assistant-Only/olmo3-dpo/${job_name}/#" \
