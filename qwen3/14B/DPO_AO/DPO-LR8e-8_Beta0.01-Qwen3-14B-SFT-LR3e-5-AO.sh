#!/bin/bash
#SBATCH --job-name=DPO-LR8e-8_Beta0.01-Qwen3-14B-SFT-LR3e-5-AO
...
export WANDB_NAME=DPO-LR8e-8_Beta0.01-Qwen3-14B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/14B/DPO_AO/dpo_beta0.01_LR8e-8.yaml
