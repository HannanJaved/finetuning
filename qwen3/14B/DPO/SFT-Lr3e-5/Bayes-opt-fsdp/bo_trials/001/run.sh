#!/bin/bash
#SBATCH --job-name=Qwen3-14B-DPO-BO-FSDP-t001
...
export WANDB_NAME=Qwen3-14B-DPO-BO-FSDP-t001
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/14B/DPO/SFT-Lr3e-5/Bayes-opt-fsdp/bo_trials/001/config.yaml
