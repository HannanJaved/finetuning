#!/bin/bash
#SBATCH --job-name=Qwen3-14B-DPO-BO-FSDP-smoketest-t000
#SBATCH --output=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/14B/DPO/SFT-LR3e-5/BayesOpt-FSDP-smoketest/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/14B/DPO/SFT-LR3e-5/BayesOpt-FSDP-smoketest/%x_%j.err
#SBATCH --nodes=1
...
export WANDB_NAME=Qwen3-14B-DPO-BO-FSDP-smoketest-t000
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/14B/DPO/SFT-Lr3e-5/Bayes-opt-fsdp-smoketest/bo_trials/000/config.yaml
