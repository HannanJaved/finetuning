#!/bin/bash
#SBATCH --job-name=qwen3_14B_dpo_smoketest
...
export WANDB_NAME=Qwen3-14B-DPO-smoketest
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/14B/DPO/SFT-Lr3e-5/Bayes-opt-fsdp-smoketest/dpo_smoketest.yaml
