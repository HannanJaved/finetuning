#!/bin/bash
#SBATCH --job-name=Qwen3-14B-DPO-BO-EarlyStop-t006
#SBATCH --output=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/14B/DPO/SFT-LR3e-5/BayesOpt-earlystop/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/14B/DPO/SFT-LR3e-5/BayesOpt-earlystop/%x_%j.err
#SBATCH --nodes=8
...
export WANDB_NAME=Qwen3-14B-DPO-BO-EarlyStop-t006
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/14B/DPO/SFT-Lr3e-5/Bayes-opt-earlystop/bo_trials/006/config.yaml
