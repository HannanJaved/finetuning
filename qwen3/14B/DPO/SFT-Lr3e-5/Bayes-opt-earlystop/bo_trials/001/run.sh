#!/bin/bash
#SBATCH --job-name=Qwen3-14B-DPO-BO-EarlyStop-t001
...
export WANDB_NAME=Qwen3-14B-DPO-BO-EarlyStop-t001
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/14B/DPO/SFT-Lr3e-5/Bayes-opt-earlystop/bo_trials/001/config.yaml
