#!/bin/bash
#SBATCH --job-name=14B_olmo_LR1e7_Beta0.1_earlystop
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/14B/DPO/SFT-Lr3e-5/Bayes-opt-earlystop/dpo_beta0.1_LR.yaml
