...
export WANDB_NAME=Qwen3-14B-SFT-LR5e-4-DPO-Beta0.1-LR1e-7
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/14B/DPO/SFT-Lr5e-4/dpo_beta0.1_LR.yaml
