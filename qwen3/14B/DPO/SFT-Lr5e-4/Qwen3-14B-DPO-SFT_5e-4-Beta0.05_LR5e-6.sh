#!/bin/bash
#SBATCH --job-name=Qwen3-14B-DPO-SFT_5e-4-Beta0.05_LR5e-6
#SBATCH --output=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/14B/DPO/SFT-LR5e-4/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/14B/DPO/SFT-LR5e-4/%x_%j.err
#SBATCH --nodes=1
...
export WANDB_NAME=Qwen3-14B-DPO-SFT_5e-4-Beta0.05_LR5e-6
...
CONFIG_FILE=/data/cat/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/14B/DPO/SFT-Lr5e-4/dpo_beta0.05_LR5e-6.yaml
