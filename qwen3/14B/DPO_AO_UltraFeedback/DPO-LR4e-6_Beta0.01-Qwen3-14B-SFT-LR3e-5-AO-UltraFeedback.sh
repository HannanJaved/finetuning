#!/bin/bash
#SBATCH --job-name=DPO-LR4e-6_Beta0.01-Qwen3-14B-SFT-LR3e-5-AO-UltraFeedback
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/14B/DPO-AO-UltraFeedback-Zero3/SFT-LR3e-5/%x_%j.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Qwen3/14B/DPO-AO-UltraFeedback-Zero3/SFT-LR3e-5/%x_%j.err
#SBATCH --nodes=1
...
export WANDB_NAME=DPO-LR4e-6_Beta0.01-Qwen3-14B-SFT-LR3e-5-AO-UltraFeedback
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/14B/DPO_AO_UltraFeedback/dpo_beta0.01_LR4e-6.yaml
