...
"""Adaptive Proximity DPO (APDO) on the original fixed preference dataset."""
...
from alignment import APDOTrainer, DPOConfig, ScriptArguments, get_dataset, get_model, get_tokenizer
...
if __name__ == "__main__":
    ...
    if not training_args.apdo_enabled:
        logger.warning("APDO script invoked with apdo_enabled=False; behavior may not match intended setup.")
