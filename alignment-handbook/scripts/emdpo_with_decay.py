...
from alignment import DPOConfig, EMDPOWithDecayTrainer, ScriptArguments, get_dataset, get_model, get_tokenizer
...
def main(script_args, training_args, model_args):
    ...
    logger.info("*** Train EM-DPO with epsilon decay ***")
    checkpoint = None
...
if __name__ == "__main__":
    ...
    if not training_args.emdpo_enabled:
        logger.warning("EM-DPO decay script invoked with emdpo_enabled=False; behavior may not match intended setup.")
