...
"""Signal-Adaptive DPO (SDPO) on the original fixed preference dataset."""
...
from alignment import DPOConfig, SDPOTrainer, ScriptArguments, get_dataset, get_model, get_tokenizer
...
if __name__ == "__main__":
    ...
    if not training_args.sdpo_enabled:
        logger.warning("SDPO script invoked with sdpo_enabled=False; behavior may not match intended setup.")
