...
"""EM-DPO-Lite on the original fixed preference dataset."""
...
from alignment import DPOConfig, EMDPOLiteTrainer, ScriptArguments, get_dataset, get_model, get_tokenizer
...
if __name__ == "__main__":
    ...
    if not training_args.emdpo_lite_enabled:
        logger.warning("EM-DPO-Lite script invoked with emdpo_lite_enabled=False; behavior may not match intended setup.")
