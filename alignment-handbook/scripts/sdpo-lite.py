...
"""Simplified SDPO on the original fixed preference dataset."""
...
from alignment import DPOConfig, SDPOLiteTrainer, ScriptArguments, get_dataset, get_model, get_tokenizer
...
if __name__ == "__main__":
    ...
    if not training_args.sdpo_lite_enabled:
        logger.warning("SDPO-Lite script invoked with sdpo_lite_enabled=False; behavior may not match intended setup.")
