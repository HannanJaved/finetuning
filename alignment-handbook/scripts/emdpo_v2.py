...
from alignment import DPOConfig, EMDPOv2Trainer, ScriptArguments, get_dataset, get_model, get_tokenizer
...
if __name__ == "__main__":
    ...
    if not training_args.emdpo_enabled:
        logger.warning("EM-DPO v2 script invoked with emdpo_enabled=False; behavior may not match intended setup.")
