...
def main(script_args, training_args, model_args):
    ...
    ref_model_path = script_args.ref_model_name_or_path or model_args.model_name_or_path
    if script_args.ref_model_name_or_path is None:
        logger.warning(
            "`ref_model_name_or_path` not provided; defaulting to the policy checkpoint."
            " Reference and policy metrics will be identical."
        )

    ref_model_args = deepcopy(model_args)
    ref_model_args.model_name_or_path = ref_model_path
    ref_model = get_model(ref_model_args, training_args)
