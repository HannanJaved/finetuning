#!/bin/bash
#SBATCH --job-name=DPO-LR1e-6_Beta0.04-Llama-3.1-8B-SFT-Lr3e-5-AO
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Llama/8B/DPO/SFT-Lr3e-5-AO/%x_%j.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Llama/8B/DPO/SFT-Lr3e-5-AO/%x_%j.err
#SBATCH --nodes=2
...
export HF_HOME="/data/cat/ws/hama901h-judge-checkpoint/.cache"
export HF_DATASETS_CACHE="/data/cat/ws/hama901h-judge-checkpoint/.cache"
source /data/cat/ws/hama901h-judge-checkpoint/cache.sh
...
export WANDB_NAME=DPO-LR1e-6_Beta0.04-Llama-3.1-8B-SFT-Lr3e-5-AO

cd /data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/alignment-handbook/
ACCELERATE_CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/qwen3/zero3.yaml
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/llama/8b/DPO/dpo_beta0.04_LR1e-6.yaml
