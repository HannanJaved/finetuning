#!/bin/bash
#SBATCH --job-name=DPO-LR4e-6_Beta0.04-Llama-3.1-8B-SFT-Lr3e-5-AO
...
export WANDB_NAME=DPO-LR4e-6_Beta0.04-Llama-3.1-8B-SFT-Lr3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/llama/8b/DPO/dpo_beta0.04_LR4e-6.yaml
