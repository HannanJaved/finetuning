#!/bin/bash
#SBATCH --job-name=Llama3.1-8B-SFT-LR3e-5-AO
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Llama/8B/%x_%j.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Llama/8B/%x_%j.err
#SBATCH --nodes=2
...
export WANDB_NAME=Llama3.1-8B-SFT-LR3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/llama/8b/config_olmo3_sft_3e-5_AO.yaml
