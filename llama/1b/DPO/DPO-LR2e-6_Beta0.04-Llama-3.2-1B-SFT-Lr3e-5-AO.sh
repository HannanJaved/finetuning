#!/bin/bash
#SBATCH --job-name=DPO-LR2e-6_Beta0.04-Llama-3.2-1B-SFT-Lr3e-5-AO
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Llama/1B/DPO/SFT-Lr3e-5-AO/%x_%j.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Llama/1B/DPO/SFT-Lr3e-5-AO/%x_%j.err
#SBATCH --nodes=2
...
#SBATCH --dependency=afterok:3996333
...
export WANDB_NAME=DPO-LR2e-6_Beta0.04-Llama-3.2-1B-SFT-Lr3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/llama/1b/DPO/dpo_beta0.04_LR2e-6.yaml
