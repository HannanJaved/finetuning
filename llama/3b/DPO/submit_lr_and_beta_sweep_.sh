...
for lr in "${LRS[@]}"; do
  for beta in "${BETAS[@]}"; do
    ...
    job_name="DPO-LR${lr}_Beta${beta}-Llama-3.2-3B-SFT-Lr3e-5-AO"
    ...
    sed \
      ...
      -e "s/^beta: .*/beta: ${beta}/" \
      -e "s#^output_dir: .*#output_dir: /data/cat/ws/hama901h-judge-checkpoint/checkpoints/Llama-3.2-3B/SFT-Lr3e-5-AO/${job_name}/#" \
