#!/bin/bash
#SBATCH --job-name=DPO-LR4e-6_Beta0.02-Llama-3.2-3B-SFT-Lr3e-5-AO
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Llama/3B/DPO/SFT-Lr3e-5-AO/%x_%j.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/Llama/3B/DPO/SFT-Lr3e-5-AO/%x_%j.err
#SBATCH --nodes=2
...
#SBATCH --dependency=afterok:3996334
...
export WANDB_NAME=DPO-LR4e-6_Beta0.02-Llama-3.2-3B-SFT-Lr3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/llama/3b/DPO/dpo_beta0.02_LR4e-6.yaml
