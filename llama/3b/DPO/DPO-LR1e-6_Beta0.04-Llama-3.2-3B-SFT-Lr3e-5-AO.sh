#!/bin/bash
#SBATCH --job-name=DPO-LR1e-6_Beta0.04-Llama-3.2-3B-SFT-Lr3e-5-AO
...
export WANDB_NAME=DPO-LR1e-6_Beta0.04-Llama-3.2-3B-SFT-Lr3e-5-AO
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/llama/3b/DPO/dpo_beta0.04_LR1e-6.yaml
