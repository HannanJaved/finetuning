#!/bin/bash
#SBATCH --job-name=sft8b_tp_16g4n
#SBATCH --output=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3-8B/throughput/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3-8B/throughput/%x_%j.err
#SBATCH --nodes=4
...
export CMD="scripts/sft.py --config $CONFIG_FILE --output_dir /data/horse/ws/hama901h-BFTranslation/checkpoints/Qwen/Qwen3-8B-Base/test_throughput/16gpu_4node/"
