#!/bin/bash
#SBATCH --job-name=sft8b_tp_12g3n
...
export CMD="scripts/sft.py --config $CONFIG_FILE --output_dir /data/horse/ws/hama901h-BFTranslation/checkpoints/Qwen/Qwen3-8B-Base/test_throughput/12gpu_3node/"
