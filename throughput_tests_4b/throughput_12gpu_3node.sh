#!/bin/bash
#SBATCH --job-name=sft4b_tp_12g3n
#SBATCH --output=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3-4B/throughput/4B/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Posttraining/.logs/Qwen3-4B/throughput/4B/%x_%j.err
#SBATCH --nodes=3
...
CONFIG_FILE=/data/cat/ws/hama901h-Posttraining/finetuning/throughput_tests_4b/config_throughput.yaml

echo "JOBNAME" $SLURM_JOB_NAME
echo "CONFIG" $CONFIG_FILE
pwd -P

export CMD="scripts/sft.py --config $CONFIG_FILE --output_dir /data/horse/ws/hama901h-BFTranslation/checkpoints/Qwen/Qwen3-4B-Base/test_throughput/12gpu_3node/"
