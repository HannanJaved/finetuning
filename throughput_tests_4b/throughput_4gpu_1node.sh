...
export CMD="scripts/sft.py --config $CONFIG_FILE --output_dir /data/horse/ws/hama901h-BFTranslation/checkpoints/Qwen/Qwen3-4B-Base/test_throughput/4gpu_1node/"
