#!/bin/bash
#SBATCH --job-name=sft_tp_12g3n
#SBATCH --output=/data/cat/ws/hama901h-Posttraining/.logs/llama8b/throughput/%x_%j.out
#SBATCH --error=/data/cat/ws/hama901h-Posttraining/.logs/llama8b/throughput/%x_%j.err
#SBATCH --nodes=3
...
CONFIG_FILE=/data/cat/ws/hama901h-Posttraining/finetuning/throughput_tests/config_throughput_12gpu_3node.yaml
