...
def main() -> None:
    ...
    parser.add_argument(
        "--logs-dir",
        type=Path,
        default=Path("/data/cat/ws/hama901h-Posttraining/.logs/llama8b/throughput"),
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("./throughput.csv"),
        help="Optional CSV output path.",
    )
    parser.add_argument(
        "--plot",
        type=Path,
        default=Path("./throughput.png"),
        metavar="FILE.png",
