#!/bin/bash
#SBATCH --job-name=datamix-9b-80-20-SFT-LR3e-5
#SBATCH --output=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/datamix-80-20-9B/%x_%j.out
#SBATCH --error=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/.logs/datamix-80-20-9B/%x_%j.err
#SBATCH --nodes=2
...
export WANDB_NAME=datamix-9b-80-20-SFT-LR3e-5
...
CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/datamix-80-20-9B/config_datamix_sft_3e-5.yaml
