#!/bin/bash
#SBATCH --job-name=9b-pilot-zero2
...
export PILOT_STRATEGY=zero2
export ACCELERATE_CONFIG_FILE=/data/horse/ws/hama901h-Post-training/hama901h-Posttraining/finetuning/datamix-80-20-9B/zero2.yaml
